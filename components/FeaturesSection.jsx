...
const FeaturesSection = () => {
  return (
    <section
      id="features"
      className="relative bg-white dark:bg-black py-24 overflow-hidden"
    >
      {/* Glow */}
      <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[320px] h-[320px] rounded-full bg-[#E63946]/15 blur-[90px]" />
      ...
      <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center gap-16">
        ...
        >
          <div className="absolute inset-0 rounded-full bg-[#E63946]/20 blur-[80px] z-0" />
          <div className="absolute inset-[20%] rounded-full bg-[#E63946]/15 blur-[60px] z-0" />
          <div className="absolute inset-[60%] rounded-full bg-[#E63946]/10 blur-[40px] z-0" />
          {/* Concentric ring decorations */}
          <div className="absolute inset-0 rounded-full border border-gray-300/60 dark:border-gray-600/60 z-10" />
          <div className="absolute inset-[18%] rounded-full border border-gray-200/60 dark:border-gray-500/60 z-10" />

          {/* Phone card */}
          <div className="relative z-10 w-[200px] md:w-[220px] h-[400px] md:h-[440px] bg-white rounded-[36px] shadow-2xl border border-gray-100 overflow-hidden">
            <FeaturePhoneMockup />
          </div>

          {/* Floating badges */}
          <div className="absolute -top-2 right-6 md:right-0 bg-white  rounded-xl shadow-lg px-3 py-2 flex items-center gap-2 z-20">
          ...
          <div className="absolute bottom-4 -left-2 md:-left-6 bg-white rounded-xl shadow-lg px-3 py-2 z-20">
          ...
          <div className="flex flex-col gap-6">
            {features.map((f, i) => (
              ...
              >
                ...
                <div>
                  <h3 className="font-bold text-black text-base dark:text-white mb-1">
                    {f.title}
                  </h3>
...
const FeaturePhoneMockup = () => (
  <div className="w-full h-full bg-gradient-to-b from-gray-50 to-gray-100 p-3 flex flex-col gap-3">
    <div className="flex justify-between items-center px-1 mb-1">
      <span className="text-[9px] font-bold text-gray-700">Welcome Back 👋</span>
    ...
    <div className="flex flex-col gap-1.5 flex-1">
      {["Netflix", "Spotify", "Amazon"].map((name, i) => (
        ...
        >
          ...
          <span className="text-[8px] text-[#E63946] font-semibold">-₹12</span>
        </div>
      ))}
    </div>
  </div>
